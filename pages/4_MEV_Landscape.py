...
# Abitrage Tokens Profits per Token
treemap_fig = go.Figure(
  ...
  layout={
    'title' : 'Arbitrage Profit per Token'
  }
)
...
bar_chart = go.Figure(
  ...
  layout={
    'title' : 'Arbitrage Counts per Token'
  }
  )
st.write(bar_chart)

# Arbers Profits charts
st.write("**Arbitrageur Profit Leaderboard**")

arber_profits = pd.read_csv('./postgres/arber_profits_in_usd.csv')
